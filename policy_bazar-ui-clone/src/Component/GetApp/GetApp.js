      ...
      <div className="px-40 mt-4 flex bg-violet-50 py-12">
        <div className="w-1/2">
          ...
          <app className="mt-12 block">
            <div className="mb-8">Download our app from</div>
        ...
        <div className="w-1/2 p-2">
          <img src="assets/GetApp/adavntages_main.png" alt="loading..."/>
        </div>
      </div>
    </div>
  );
